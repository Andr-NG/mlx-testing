...
class MoveProfile(BaseModel):
    ...
    MoveProfile
    """ # noqa: E501
    ids: Annotated[List[StrictStr], Field(min_length=1, max_length=20)]
    dest_folder_id: StrictStr
    __properties: ClassVar[List[str]] = ["ids", "dest_folder_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ids": obj.get("ids"),
            "dest_folder_id": obj.get("dest_folder_id")
        })
        return _obj
