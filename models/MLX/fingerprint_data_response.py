...
class FingerprintDataResponse(BaseModel):
    """
    FingerprintDataResponse
    """ # noqa: E501
    status: ResponseStatus
    data: Optional[FingerprintData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FingerprintData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
