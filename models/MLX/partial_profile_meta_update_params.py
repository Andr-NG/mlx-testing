...
class PartialProfileMetaUpdateParams(BaseModel):
    """
    PartialProfileMetaUpdateParams
    """ # noqa: E501
    flags: Optional[ProfileMetaFlagsOptional] = None
    fingerprint: Optional[FingerprintData] = None
    __properties: ClassVar[List[str]] = ["flags", "fingerprint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flags": ProfileMetaFlagsOptional.from_dict(obj["flags"]) if obj.get("flags") is not None else None,
