...
class ProfileMetaArrayResponse(BaseModel):
    """
    ProfileMetaArrayResponse
    """ # noqa: E501
    status: ResponseStatus
    data: Optional[ProfileMetaArray] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ProfileMetaArray.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
