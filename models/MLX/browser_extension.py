...
class BrowserExtension(BaseModel):
    ...
    name: StrictStr = Field(description="Extension name")
    url: StrictStr = Field(description="Extension store link")
    store: StrictStr = Field(description="Chrome Web Store or Mozilla Addons")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "store"]
